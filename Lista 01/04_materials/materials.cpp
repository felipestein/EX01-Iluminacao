...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // red rubber
        lightingShader.setVec3("material.ambient", 0.05f, 0.0f, 0.0f);
        lightingShader.setVec3("material.diffuse", 0.5f, 0.4f, 0.4f);
        lightingShader.setVec3("material.specular", 0.7f, 0.04f, 0.04f);
